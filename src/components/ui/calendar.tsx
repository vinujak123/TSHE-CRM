    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-8 w-8 sm:h-7 sm:w-7 bg-transparent p-0 opacity-50 hover:opacity-100 transition-opacity border-gray-200 hover:border-gray-300"
        ),
        nav_button_previous: "absolute left-1 sm:left-1",
        nav_button_next: "absolute right-1 sm:right-1",
        table: "w-full border-collapse space-y-1",
        head_row: "flex",
        head_cell:
          "text-muted-foreground rounded-md w-8 h-8 sm:w-9 sm:h-9 font-normal text-[0.75rem] sm:text-[0.8rem] flex items-center justify-center",
        ...
        day: cn(
          ...
          "h-8 w-8 sm:h-9 sm:w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-gray-100 transition-colors text-sm"
        ),
